...
public class CompanyReportDocumentInfoServiceImpl implements DocumentInfoService {
    ...
    public DocumentInfoResponse getDocumentInfo(DocumentInfoRequest documentInfoRequest) throws DocumentInfoException {
        ...
        try {
            return companyReportDataHandler.getCompanyReportData(resourceUri, requestId);
        } catch (HandlerException he) {
            LOG.errorContext(requestId, String.format("An error occurred when retrieving the data for the company report"), he, debugMap);
